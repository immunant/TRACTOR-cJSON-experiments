...
pub fn cJSON_GetStringValue(item: Option<&cJSON>) -> *mut ::core::ffi::c_char {
    ...
    return item.unwrap().valuestring;
}
...
pub fn cJSON_Version() -> &'static ::core::ffi::CStr {
    ::core::ffi::CStr::from_bytes_with_nul(b"1.7.19\0")
        .expect("static cJSON version string is null-terminated")
}
...
unsafe extern "C" fn case_insensitive_strcmp(
    ...
    return tolower(*string1 as ::core::ffi::c_int) - tolower(*string2 as ::core::ffi::c_int);
}
...
unsafe extern "C" fn cJSON_New_Item(hooks: *const internal_hooks) -> *mut cJSON {
    ...
    if !node.is_null() {
        ::core::ptr::write(node, cJSON::default());
    }
    return node;
}
...
unsafe extern "C" fn parse_number(
    ...
    let content = input_buffer_ref.content;
    i = 0 as size_t;
    while input_buffer_ref.offset.wrapping_add(i) < input_buffer_ref.length {
        match content[input_buffer_ref.offset.wrapping_add(i)] as ::core::ffi::c_int {
    ...
    let number_slice = ::core::slice::from_raw_parts_mut(
        number_c_string,
        number_string_length.wrapping_add(1 as size_t),
    );
    i = 0 as size_t;
    while i < number_string_length {
        number_slice[i] = content[input_buffer_ref.offset.wrapping_add(i)];
        i = i.wrapping_add(1);
    }
    number_slice[number_string_length] = '\0' as i32 as ::core::ffi::c_uchar;
    if has_decimal_point != 0 {
        i = 0 as size_t;
        while i < number_string_length {
            if number_slice[i] as ::core::ffi::c_int == '.' as i32 {
                number_slice[i] = decimal_point;
            }
            i = i.wrapping_add(1);
        }
    }
    ...
    cJSON_InitNumber(&mut *item, number);
...
fn cJSON_InitNumber(object: &mut cJSON, number: ::core::ffi::c_double) {
    object.type_0 = cJSON_Number;
    cJSON_SetNumberHelper(object, number);
}
fn cJSON_InitType(object: &mut cJSON, type_0: ::core::ffi::c_int) {
...
pub unsafe extern "C" fn cJSON_SetNumberHelper_ffi(
    ...
    cJSON_SetNumberHelper(object.as_mut().expect("non-null cJSON pointer"), number)
}
...
fn compare_double(a: ::core::ffi::c_double, b: ::core::ffi::c_double) -> cJSON_bool {
    let a_abs = a.abs();
    let b_abs = b.abs();
    let maxVal: ::core::ffi::c_double = if a_abs > b_abs { a_abs } else { b_abs };
...
fn utf16_literal_to_utf8(
    ...
    let mut utf8_length: usize = 0 as usize;
    ...
    if !(input.len() < 6 as usize) {
        first_code = parse_hex4(&input[2 as usize..6 as usize]);
            ...
            && first_code <= 0xdfff as ::core::ffi::c_uint)
        {
                ...
                && first_code <= 0xdbff as ::core::ffi::c_uint
            {
                ...
                if input.len().wrapping_sub(6 as usize) < 6 as usize {
                    ...
                    || input[7 as usize] as ::core::ffi::c_int != 'u' as i32
                {
                    ...
                    second_code = parse_hex4(&input[8 as usize..12 as usize]);
            ...
            if codepoint < 0x80 as ::core::ffi::c_ulong {
                utf8_length = 1 as usize;
            } else if codepoint < 0x800 as ::core::ffi::c_ulong {
                utf8_length = 2 as usize;
                first_byte_mark = 0xc0 as ::core::ffi::c_uchar;
            } else if codepoint < 0x10000 as ::core::ffi::c_ulong {
                utf8_length = 3 as usize;
                first_byte_mark = 0xe0 as ::core::ffi::c_uchar;
            } else if codepoint <= 0x10ffff as ::core::ffi::c_ulong {
                utf8_length = 4 as usize;
                first_byte_mark = 0xf0 as ::core::ffi::c_uchar;
            } else {
                return 0 as ::core::ffi::c_uchar;
            }
            if output.len().saturating_sub(*output_offset) < utf8_length {
                return 0 as ::core::ffi::c_uchar;
            }
            let start = *output_offset;
            let mut utf8_position = utf8_length.wrapping_sub(1 as usize);
            while utf8_position > 0 as usize {
                output[start + utf8_position] = ((codepoint | 0x80 as ::core::ffi::c_ulong)
                    & 0xbf as ::core::ffi::c_ulong)
                    as ::core::ffi::c_uchar;
                codepoint >>= 6 as ::core::ffi::c_int;
                utf8_position = utf8_position.wrapping_sub(1 as usize);
            }
            if utf8_length > 1 as usize {
                output[start] = ((codepoint | first_byte_mark as ::core::ffi::c_ulong)
                    & 0xff as ::core::ffi::c_ulong)
                    as ::core::ffi::c_uchar;
            } else {
                output[start] = (codepoint & 0x7f as ::core::ffi::c_ulong) as ::core::ffi::c_uchar;
            }
...
fn scan_json_string(
    input: &[::core::ffi::c_uchar],
    input_offset: size_t,
) -> Option<(size_t, size_t)> {
    if input.get(input_offset).copied() != Some('"' as i32 as ::core::ffi::c_uchar) {
        return None;
    }

    let mut input_end = input_offset.wrapping_add(1 as size_t);
    ...
    loop {
        ...
        if input[input_end] as ::core::ffi::c_int == '\\' as i32 {
            if input_end.wrapping_add(1 as size_t) >= input.len() {
                return None;
            }
...
fn decode_json_string(
    ...
    let mut input_position = input_offset.wrapping_add(1 as size_t);
    let mut output_offset: usize = 0 as usize;
    loop {
        if !(input_position < input_end) {
            break;
        }
        if input[input_position] as ::core::ffi::c_int != '\\' as i32 {
            output[output_offset] = input[input_position];
            input_position = input_position.wrapping_add(1 as size_t);
            output_offset = output_offset.wrapping_add(1 as usize);
        } else {
            let mut sequence_length: ::core::ffi::c_uchar = 2 as ::core::ffi::c_uchar;
            if input_end.wrapping_sub(input_position) < 1 as size_t {
                return Err(input_position);
            }
            match input[input_position.wrapping_add(1 as size_t)] as ::core::ffi::c_int {
                98 => {
                    output[output_offset] = '\u{8}' as i32 as ::core::ffi::c_uchar;
                    output_offset = output_offset.wrapping_add(1 as usize);
                }
                102 => {
                    output[output_offset] = '\u{c}' as i32 as ::core::ffi::c_uchar;
                    output_offset = output_offset.wrapping_add(1 as usize);
                }
                110 => {
                ...
                114 => {
                    output[output_offset] = '\r' as i32 as ::core::ffi::c_uchar;
                    output_offset = output_offset.wrapping_add(1 as usize);
                }
                116 => {
                    output[output_offset] = '\t' as i32 as ::core::ffi::c_uchar;
                    output_offset = output_offset.wrapping_add(1 as usize);
                }
                34 | 92 | 47 => {
                    output[output_offset] = input[input_position.wrapping_add(1 as size_t)];
                    output_offset = output_offset.wrapping_add(1 as usize);
                }
                117 => {
                    let input_slice = &input[input_position..input_end];
                    sequence_length =
                        utf16_literal_to_utf8(input_slice, output, &mut output_offset);
            ...
            input_position = input_position.wrapping_add(sequence_length as size_t);
        }
    }
...
unsafe extern "C" fn parse_string(
    ...
    let input_buffer_ref = input_buffer;
    let input = input_buffer_ref.content;
    let input_offset = input_buffer_ref.offset;
    let mut input_position = input_offset.wrapping_add(1 as size_t);
    let mut output: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<::core::ffi::c_uchar>();
    let mut parse_succeeded = false;

    if let Some((input_end, allocation_length)) = scan_json_string(input, input_offset) {
        ...
        if !output.is_null() {
            let output_length = allocation_length
                .wrapping_add(::core::mem::size_of::<[::core::ffi::c_char; 1]>() as size_t);
            let output_slice = ::core::slice::from_raw_parts_mut(output, output_length as usize);
            match decode_json_string(input, input_offset, input_end, output_slice) {
                Ok(output_offset) => {
                    output_slice[output_offset] = '\0' as i32 as ::core::ffi::c_uchar;
                ...
                Err(failure_position) => {
                    input_position = failure_position;
                }
            }
        }
    }
    ...
    input_buffer_ref.offset = input_position;
    return false_0;
}
...
fn buffer_skip_whitespace(buffer_ref: &mut parse_buffer<'_>) {
    if buffer_ref.offset >= buffer_ref.length {
        return;
    }
    let content = buffer_ref.content;
    while buffer_ref.offset < buffer_ref.length
        && content[buffer_ref.offset] as ::core::ffi::c_int <= 32 as ::core::ffi::c_int
    {
...
fn skip_utf8_bom(buffer_ref: &mut parse_buffer<'_>) {
    if buffer_ref.offset != 0 as size_t {
        return;
    }
    let content = buffer_ref.content;
    if buffer_ref.offset.wrapping_add(4 as size_t) < buffer_ref.length
        && content.get(buffer_ref.offset..buffer_ref.offset.wrapping_add(3 as size_t))
            == Some(b"\xEF\xBB\xBF" as &[::core::ffi::c_uchar])
    {
        buffer_ref.offset = buffer_ref.offset.wrapping_add(3 as size_t);
    }
}
            ...
            if !(parse_value(item, &mut buffer) == 0) {
                if require_null_terminated != 0 {
                    ...
                    if buffer.offset >= buffer.length
                        || buffer.content.get(buffer.offset).copied()
...
unsafe extern "C" fn print(
    ...
    buffer.buffer = (*hooks).allocate.expect("non-null function pointer")(default_buffer_size)
        as *mut ::core::ffi::c_uchar;
            ...
            if (*hooks).reallocate.is_some() {
                ...
                if printed.is_null() {
                    ...
                    memcpy(
                        ...
                        buffer.buffer as *const ::core::ffi::c_void,
                        if buffer.length < buffer.offset.wrapping_add(1 as size_t) {
                            buffer.length
                        } else {
                            buffer.offset.wrapping_add(1 as size_t)
                        },
                    );
                    *printed.offset(buffer.offset as isize) = '\0' as i32 as ::core::ffi::c_uchar;
...
pub unsafe extern "C" fn cJSON_Print(mut item: *const cJSON) -> *mut ::core::ffi::c_char {
...
unsafe extern "C" fn parse_value(
    ...
    let input_buffer_ref = input_buffer;
    let content = input_buffer_ref.content;
    if content.get(input_buffer_ref.offset..input_buffer_ref.offset.wrapping_add(4 as size_t))
        == Some(b"null" as &[::core::ffi::c_uchar])
    {
        (*item).type_0 = cJSON_NULL;
        input_buffer_ref.offset = input_buffer_ref.offset.wrapping_add(4 as size_t);
        return true_0;
    }
    if content.get(input_buffer_ref.offset..input_buffer_ref.offset.wrapping_add(5 as size_t))
        == Some(b"false" as &[::core::ffi::c_uchar])
    {
    ...
    if content.get(input_buffer_ref.offset..input_buffer_ref.offset.wrapping_add(4 as size_t))
        == Some(b"true" as &[::core::ffi::c_uchar])
    {
    ...
    let current_byte = match content.get(input_buffer_ref.offset).copied() {
        Some(byte) => byte,
        None => return false_0,
    };
    if current_byte as ::core::ffi::c_int == '"' as i32 {
        return parse_string(item, input_buffer_ref);
    }
    if current_byte as ::core::ffi::c_int == '-' as i32
        || (current_byte as ::core::ffi::c_int >= '0' as i32
            && current_byte as ::core::ffi::c_int <= '9' as i32)
    {
        return parse_number(item, input_buffer_ref);
    }
    if current_byte as ::core::ffi::c_int == '[' as i32 {
        return parse_array(item, input_buffer_ref);
    }
    if current_byte as ::core::ffi::c_int == '{' as i32 {
        return parse_object(item, input_buffer_ref);
    }
    return false_0;
}
    ...
    if content.get(input_buffer_ref.offset).copied() == Some('[' as i32 as ::core::ffi::c_uchar) {
            ...
            == Some(']' as i32 as ::core::ffi::c_uchar)
        {
            ...
            loop {
                ...
                input_buffer_ref.offset = input_buffer_ref.offset.wrapping_add(1);
                buffer_skip_whitespace(input_buffer_ref);
                if parse_value(current_item, input_buffer_ref) == 0 {
                    c2rust_current_block = 1336238348363633231;
                    break;
                }
                buffer_skip_whitespace(input_buffer_ref);
            ...
            loop {
                ...
                if new_item.is_null() {
                    ...
                    if input_buffer_ref.offset.wrapping_add(1 as size_t) >= input_buffer_ref.length
                    {
                        ...
                        input_buffer_ref.offset = input_buffer_ref.offset.wrapping_add(1);
                        buffer_skip_whitespace(input_buffer_ref);
                        if parse_string(current_item, input_buffer_ref) == 0 {
                            c2rust_current_block = 9990476168629568694;
                            break;
                        } else {
                            buffer_skip_whitespace(input_buffer_ref);
...
extern "C" fn cast_away_const(mut string: *const ::core::ffi::c_void) -> *mut ::core::ffi::c_void {
...
pub unsafe extern "C" fn cJSON_CreateNull() -> *mut cJSON {
    ...
    if !item.is_null() {
        cJSON_InitType(&mut *item, cJSON_NULL);
    }
    return item;
}
...
pub unsafe extern "C" fn cJSON_CreateTrue() -> *mut cJSON {
    let mut item: *mut cJSON = cJSON_New_Item(&raw mut global_hooks);
    if !item.is_null() {
        cJSON_InitType(&mut *item, cJSON_True);
    }
    return item;
}
...
pub unsafe extern "C" fn cJSON_CreateFalse() -> *mut cJSON {
    let mut item: *mut cJSON = cJSON_New_Item(&raw mut global_hooks);
    if !item.is_null() {
        cJSON_InitType(&mut *item, cJSON_False);
    }
    return item;
}
...
pub unsafe extern "C" fn cJSON_CreateBool(mut boolean: cJSON_bool) -> *mut cJSON {
    let mut item: *mut cJSON = cJSON_New_Item(&raw mut global_hooks);
    if !item.is_null() {
        let type_0 = if boolean != 0 {
            cJSON_True
        } else {
            cJSON_False
        };
        cJSON_InitType(&mut *item, type_0);
    }
    return item;
}
...
pub unsafe extern "C" fn cJSON_CreateString(mut string: *const ::core::ffi::c_char) -> *mut cJSON {
    ...
    if !item.is_null() {
        let item_ref = &mut *item;
        cJSON_InitType(item_ref, cJSON_String);
        item_ref.valuestring =
            cJSON_strdup(string as *const ::core::ffi::c_uchar, &raw mut global_hooks)
                as *mut ::core::ffi::c_char;
...
pub unsafe extern "C" fn cJSON_CreateStringReference(
    ...
    if !item.is_null() {
        let item_ref = &mut *item;
        cJSON_InitType(item_ref, cJSON_String | cJSON_IsReference);
        item_ref.valuestring =
...
pub unsafe extern "C" fn cJSON_CreateObjectReference(mut child: *const cJSON) -> *mut cJSON {
    let mut item: *mut cJSON = cJSON_New_Item(&raw mut global_hooks);
    if !item.is_null() {
        let item_ref = &mut *item;
        cJSON_InitType(item_ref, cJSON_Object | cJSON_IsReference);
        item_ref.child = cast_away_const(child as *const ::core::ffi::c_void) as *mut cJSON;
    }
    return item;
}
...
pub unsafe extern "C" fn cJSON_CreateArrayReference(mut child: *const cJSON) -> *mut cJSON {
    let mut item: *mut cJSON = cJSON_New_Item(&raw mut global_hooks);
    if !item.is_null() {
        let item_ref = &mut *item;
        cJSON_InitType(item_ref, cJSON_Array | cJSON_IsReference);
        item_ref.child = cast_away_const(child as *const ::core::ffi::c_void) as *mut cJSON;
    }
    return item;
}
...
pub unsafe extern "C" fn cJSON_CreateRaw(mut raw: *const ::core::ffi::c_char) -> *mut cJSON {
    ...
    if !item.is_null() {
        let item_ref = &mut *item;
        cJSON_InitType(item_ref, cJSON_Raw);
        item_ref.valuestring =
...
pub unsafe extern "C" fn cJSON_CreateArray() -> *mut cJSON {
    let mut item: *mut cJSON = cJSON_New_Item(&raw mut global_hooks);
    if !item.is_null() {
        cJSON_InitType(&mut *item, cJSON_Array);
    }
    return item;
}
...
pub unsafe extern "C" fn cJSON_CreateObject() -> *mut cJSON {
    let mut item: *mut cJSON = cJSON_New_Item(&raw mut global_hooks);
    if !item.is_null() {
        cJSON_InitType(&mut *item, cJSON_Object);
    }
    return item;
}
...
pub unsafe fn cJSON_CreateIntArray(numbers: &[::core::ffi::c_int]) -> *mut cJSON {
...
pub unsafe fn cJSON_CreateFloatArray(numbers: &[::core::ffi::c_float]) -> *mut cJSON {
    let a: *mut cJSON = cJSON_CreateArray();
    for number in numbers {
        let n: *mut cJSON = cJSON_CreateNumber(*number as ::core::ffi::c_double);
        if n.is_null() {
...
pub unsafe fn cJSON_CreateDoubleArray(numbers: &[::core::ffi::c_double]) -> *mut cJSON {
    let a: *mut cJSON = cJSON_CreateArray();
    for number in numbers {
...
pub unsafe fn cJSON_CreateStringArray(strings: &[*const ::core::ffi::c_char]) -> *mut cJSON {
    let a: *mut cJSON = cJSON_CreateArray();
...
pub unsafe extern "C" fn cJSON_CreateStringArray_ffi(
    ...
    cJSON_CreateStringArray(::core::slice::from_raw_parts(strings, count as usize))
}
...
fn is_c_char(value: ::core::ffi::c_char, expected: u8) -> bool {
    value == expected as ::core::ffi::c_char
}
fn skip_oneline_comment(input: &mut usize, json: &[::core::ffi::c_char]) {
    *input = input.wrapping_add(2);
    while *input < json.len() && !is_c_char(json[*input], b'\0') {
        if is_c_char(json[*input], b'\n') {
    ...
    *input = input.wrapping_add(2);
    while *input < json.len() && !is_c_char(json[*input], b'\0') {
        if is_c_char(json[*input], b'*')
            && input
                .checked_add(1)
                .and_then(|next| json.get(next))
                .is_some_and(|next| is_c_char(*next, b'/'))
        {
            *input = input.wrapping_add(2);
            return;
        }
...
fn minify_string(input: &mut usize, output: &mut usize, json: &mut [::core::ffi::c_char]) {
    if *input >= json.len() || *output >= json.len() {
        return;
    }
    ...
    *output = output.wrapping_add(1);
    while *input < json.len() && !is_c_char(json[*input], b'\0') {
        ...
        json[*output] = json[*input];
        if is_c_char(json[*input], b'"') {
            json[*output] = b'"' as ::core::ffi::c_char;
            *input = input.wrapping_add(1);
            *output = output.wrapping_add(1);
            return;
        } else if is_c_char(json[*input], b'\\')
            && input
                .checked_add(1)
                .and_then(|next| json.get(next))
                .is_some_and(|next| is_c_char(*next, b'"'))
        {
            if output.checked_add(1).is_some_and(|next| next < json.len()) {
...
pub fn cJSON_Minify(json: &mut [::core::ffi::c_char]) {
    ...
    while read < json.len() && !is_c_char(json[read], b'\0') {
        match json[read] as ::core::ffi::c_int {
            32 | 9 | 13 | 10 => {
                read = read.wrapping_add(1);
            }
            47 => {
                let next = read.checked_add(1).and_then(|next| json.get(next)).copied();
                if next.is_some_and(|next| is_c_char(next, b'/')) {
                    skip_oneline_comment(&mut read, json);
                } else if next.is_some_and(|next| is_c_char(next, b'*')) {
                    skip_multiline_comment(&mut read, json);
                } else {
                    read = read.wrapping_add(1);
                }
            }
            34 => {
                minify_string(&mut read, &mut write, json);
            }
            _ => {
                if write >= json.len() {
                    return;
    ...
    if write < json.len() {
        json[write] = b'\0' as ::core::ffi::c_char;
    }
}
...
pub unsafe extern "C" fn cJSON_Minify_ffi(mut json: *mut ::core::ffi::c_char) {
    ...
    let length =
        strlen(json).wrapping_add(::core::mem::size_of::<[::core::ffi::c_char; 1]>() as size_t);
...
pub unsafe extern "C" fn cJSON_free(mut object: *mut ::core::ffi::c_void) {
    ...
    object = ::core::ptr::null_mut::<::core::ffi::c_void>();
}
